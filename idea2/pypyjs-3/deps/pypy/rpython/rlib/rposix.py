...
# off_t.
if not _WIN32:
    if OFF_T_SIZE != rffi.sizeof(rffi.LONGLONG):      #AYGOR
        print("AYGOR OFF_T_SIZE=",OFF_T_SIZE," rffi.LL=",rffi.sizeof(rffi.LONGLONG))
    #assert OFF_T_SIZE == rffi.sizeof(rffi.LONGLONG)  # AYGOR
