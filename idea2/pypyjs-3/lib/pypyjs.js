...
function pypyjs(opts) {
  ...
  if (!pypyjs._vmBuilderPromise) {
    pypyjs._vmBuilderPromise = this.fetch('pypyjs.vm.js').then(function (xhr) {
      ...
      'dependenciesFulfilled=function() { inDependenciesFulfilled(FS); };', 'if(typeof memoryInitializer==="undefined"||!memoryInitializer||(!ENVIRONMENT_IS_WEB&&!ENVIRONMENT_IS_WORKER))dependenciesFulfilled();'].join('\r\n');
